 ...
 * Convert 0f..1f -> 0..255
 */
private fun Float.toUByte(): UByte = (this * 255f).toInt().toUByte()

/**
 * Convert 0..255 -> 0f..1f.
 */
private fun Int.normalised(): Float = this.toFloat() / 255f
...
private object ColorAsStringSerializer : KSerializer<Color> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("org.beatonma.formio.core.graphics.Color", PrimitiveKind.STRING)
